	...
	specAgents := []db.Agent{
		{
			...
			Description:      "Nghiên cứu và trích xuất dữ liệu từ bất kỳ URL nào sử dụng Apify & DeepSeek.",
			Category:         "research",
		...
		},
		{
			...
			Description:      "Phân tích toàn diện dự án crypto từ website, docs, và mạng xã hội. Trả về hồ sơ đầu tư có cấu trúc.",
			Category:         "research",
		...
		},
		{
			...
			Description:      "Thu thập bài đăng về bất kỳ chủ đề nào và trả về điểm sentiment cùng tóm tắt xu hướng.",
			Category:         "analysis",
		...
		},
		{
			...
			Description:      "Đọc whitepaper, tài liệu kỹ thuật và trả về tóm tắt có cấu trúc, điểm chính và cảnh báo rủi ro.",
			Category:         "analysis",
		...
		},
		{
			...
			Description:      "Tổng hợp kết quả từ nhiều agent thành báo cáo nghiên cứu hoàn chỉnh, memo đầu tư, hoặc Twitter thread.",
			Category:         "content",
