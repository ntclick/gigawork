 ...
 * Supports off-chain creation (free and instant) and a single on-chain transaction draw.
 */
contract CosmicRaffle {
     ...
     * Anyone can verify, but host wallet runs and signs the transaction.
     */
    function drawRaffle(
        bytes32 _merkleRoot,
        ...
        // Push an empty struct and populate to avoid EVM copy issues
