...
const artifactPath = path.resolve(__dirname, '../contracts/CosmicRaffleFactory.json')

async function main() {
  console.log(`\n🏗  Deploying CosmicRaffleFactory...`)
  ...
  if (!fs.existsSync(artifactPath)) {
    throw new Error(`Compiled artifact not found at ${artifactPath}. Run: npx tsx scripts/compile-factory.ts`)
  }
  ...
  console.log(`\n✅ CosmicRaffleFactory deployed!`)
  console.log(`   Address:  ${contractAddress}`)
  console.log(`   Explorer: ${EXPLORER}/address/${contractAddress}`)
  console.log(`\n   Add to .env or .env.local:`)
  console.log(`   NEXT_PUBLIC_COSMIC_RAFFLE_FACTORY_ADDRESS=${contractAddress}\n`)
}
